...
export interface WaInteractiveButtonInput {
    ...
    readonly merchantUrl?: string | false;
    ...
    readonly buttonParamsJson?: string | object;
    readonly buttonParamsJSON?: string | object;
}
export interface WaInteractiveMessageInput {
    readonly title?: string;
    ...
    readonly buttons?: readonly WaInteractiveButtonInput[];
    readonly interactiveButtons?: readonly WaInteractiveButtonInput[];
    readonly messageParamsJson?: string | object;
    readonly messageVersion?: number;
    readonly image?: WaUploadMediaSource;
    readonly imageMimetype?: string;
    readonly imageMessage?: Proto.Message.IImageMessage;
    readonly video?: WaUploadMediaSource;
    readonly videoMimetype?: string;
    /** Play an MP4 video header as a looping WhatsApp GIF. */
    readonly gifPlayback?: boolean;
    readonly videoMessage?: Proto.Message.IVideoMessage;
    readonly documentMessage?: Proto.Message.IDocumentMessage;
    readonly mimetype?: string;
    readonly contextInfo?: Proto.IContextInfo;
    /** Wrap the interactive message in a WhatsApp viewOnce envelope. */
    readonly viewOnce?: boolean;
}
export interface WaListRowInput {
    readonly title: string;
    readonly description?: string;
    readonly id?: string;
    readonly rowId?: string;
}
export interface WaListSectionInput {
    readonly title?: string;
    readonly rows: readonly WaListRowInput[];
}
export interface WaListMessageInput {
    readonly title?: string;
    readonly description?: string;
    readonly text?: string;
    readonly body?: string;
    ...
    readonly sections: readonly WaListSectionInput[];
}
export interface WaCarouselMessageInput extends Omit<WaInteractiveMessageInput, 'buttons' | 'interactiveButtons'> {
    readonly cards: readonly WaInteractiveMessageInput[];
    readonly carouselCardType?: number;
}
...
export declare class WaMessageCoordinator {
    ...
    /** Sends a Native Flow interactive message. */
    sendInteractive(to: string, input: WaInteractiveMessageInput, options?: WaSendMessageOptions): Promise<WaMessagePublishResult>;
    /** Alias for sendInteractive. */
    sendButtons(to: string, input: WaInteractiveMessageInput, options?: WaSendMessageOptions): Promise<WaMessagePublishResult>;
    /** Sends the classic listMessage format. */
    sendList(to: string, input: WaListMessageInput, options?: WaSendMessageOptions): Promise<WaMessagePublishResult>;
    /** Sends an InteractiveMessage carousel. */
    sendCarousel(to: string, input: WaCarouselMessageInput, options?: WaSendMessageOptions): Promise<WaMessagePublishResult>;
